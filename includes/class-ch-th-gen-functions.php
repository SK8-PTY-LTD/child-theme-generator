    ...
    public function child_themes_setup()
    {
        ...
        <form method="post" action="">
            ...
            <fieldset>
                <table>
                            ...
                            <select name="parent">
                                ...
                                foreach ($parent_themes as $key => $value) {
                                    ...
                                    if ($runningTheme->get('Name') == $parent_themes[$key]->get('Name')) {
                                        ?>
                                        <option value="<?php echo $parent_themes[$key]->get_stylesheet(); ?>"
                                                selected="selected">
                    ...
                    <tr>
                        ...
                        <td class="FBInput"><input type="text" name="description"
                                                   value="This is a child theme created for"></td>
                    ...
                    <tr>
                        ...
                        <td class="FBInput"><input type="text" name="author-url"
                                                   value="<?php echo "https://sk8.tech/" ?>"></td>
            ...
            <input type="submit" name="Submit" class="button-primary"
                   value="<?php esc_html_e('Create new child theme', 'ch-th-gen'); ?>"/>
        </form>
        <?php
        ...
        if (!empty($child_themes)) {
            ...
            <form method='post' action=''>
                ...
                foreach ($child_themes as $key => $content) {
                    ?>
                    <p><input type="radio" name="folder_to_remove"
                              value="<?php echo $child_themes[$key]->get_stylesheet(); ?>">
                        <?php echo "<b>" . $content . "</b> (" . $child_themes[$key]->get_template() . " child theme)<br />"; ?>
                        </input>
                        <input type="hidden" name="parent_to_restore"
                               value="<?php echo $child_themes[$key]->get_template(); ?>"></p>
                    <?php
                }
                ?>
                ...
                <div id="confirm">
                    ...
                    <input type="submit" class="button-primary" name="btn-confirm-remove"
                           value="<?php esc_html_e(' Confirm ', 'ch-th-gen'); ?>"/>
                </div>
            </form>
            <?php
        } else {
