...
== Changelog ==
= 2.1 =
Fixed bugs related to directory-name ch-th-gen
...
=======
1. Go to `Settings`, then click on `Child-Theme Gen`, select a parent-theme from drop-down menu.
2. Fill out the form (all fields are optional):
3. Finally, click on `Create it` button.
