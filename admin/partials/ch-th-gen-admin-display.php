...
>>>>>>> 5e247be19e9a3c5ea51d83d15bf2fb894ed9f9af
				...
				if ( !is_writable( $theme_path ) ) {
					...
					printf( esc_html__(' Fatal error: cannot continue because the theme root folder is write-protected - permissions detected: %1$s', 'ch-th-gen'), $perms_path );
					echo "<br /><br />";
					printf( esc_html__('Tips: change your folder\'s permissions to writing on %1$s %2$s %3$s before continue.', 'ch-th-gen'),'<em><b>', $theme_path, '</b></em>' );
					echo '<br /><br /></div>';
					die();
				}
				switch ($tab):
...
>>>>>>> 5e247be19e9a3c5ea51d83d15bf2fb894ed9f9af
					...
					<div class="meta-box-sortables ui-sortable">
						<div class="postbox ">
							<div class="inside">
								<div class="ctg-btn">
									<?php
									printf( esc_html__('%1$s Follow me & Review %2$s', 'ch-th-gen'), '<h3>', '</h3>'); ?>
									<!-- Facebook button -->
									<div id="fb-root"></div>
								...
								<div class="ctg-btn">
									...
									<div>
									<?php
									printf( esc_html__('Your feedback and review are both important, %1$s Rate this plugin! %2$s', 'ch-th-gen'), '<a href=' . $review_link .' target="blank">', '</a></span>' );
									 ?>
									</div>
									<div class="clear">
								</div>
				...
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox ">
						<div class="inside">
							<p>
								<?php esc_html_e( 'Thank you for using Child Theme Generator. This plugin is free and you can use it whenever you wish. If you have appreciated my work, consider a small donation to show your appreciation. Thanks! ', 'ch-th-gen');?>
								<br />
					...
					<div id="itsec_security_updates" class="postbox ">
						<div class="inside">
							...
							<div id="mc_embed_signup">
								<?php
								printf( esc_html__('%1$s Keep in touch %2$s', 'ch-th-gen'), '<h3>', '</h3>');
								printf( esc_html__( 'This plugins has been coded with the best practices, it will not slow down your website or spam your database.', 'ch-th-gen'), '<br /><br />');
								printf( esc_html__('Subscribe to get notificed once new plugin is out. No spam, just one mail per one new plugin.%1$s', 'ch-th-gen'), '<br />') ;
								?>
								<form action="//serafinocorriero.us14.list-manage.com/subscribe/post?u=36743ae007e3020c68fe9b2e1&amp;id=af9acf8548" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
									<div id="mc_embed_signup_scroll">
										<label for="mce-EMAIL"><?php esc_html_e('Subscribe to my mailing list', 'ch-th-gen'); ?></label>
										<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="<?php esc_html_e('Email address', 'ch-th-gen'); ?>" required>
