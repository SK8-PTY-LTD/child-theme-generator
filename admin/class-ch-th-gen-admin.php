...
>>>>>>> 5e247be19e9a3c5ea51d83d15bf2fb894ed9f9af
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/ch-th-gen-admin.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		 ...
		 * class.
		 */
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/ch-th-gen-admin.js', array( 'jquery' ), $this->version, false );
	}
...
>>>>>>> 5e247be19e9a3c5ea51d83d15bf2fb894ed9f9af
	...
	*/
	public function display_options_page() {
		include_once 'partials/ch-th-gen-admin-display.php';
	}
	...
	public function section_create() {
		...
		if( isset($_POST[ 'hidden_field' ]) ) {
			...
			$new_child_theme['description'] = empty( $new_child_theme['description'] ) ? __('Write here a brief description about your child-theme', 'ch-th-gen') : $new_child_theme['description'];
			$new_child_theme['author'] = empty( $new_child_theme['author'] ) ? __('Write here the author\'s name', 'ch-th-gen') : $new_child_theme['author'];
			$new_child_theme['author-url'] = empty( $new_child_theme['author-url'] ) ? __('Write here the author\'s blog or website url', "ch-th-gen") : $new_child_theme['author-url'];
...
>>>>>>> 5e247be19e9a3c5ea51d83d15bf2fb894ed9f9af
				...
				<div class="pad1">
					<?php
					printf( esc_html__( 'Child Theme %1$s %2$s %3$s has been created successfully!', 'ch-th-gen'), "<b>", $new_child_theme['title'], "</b>");
					?>
