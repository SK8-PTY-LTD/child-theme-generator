 ...
 * This action is documented in includes/class-ch-th-gen-activator.php
 */
function activate_ch_th_gen() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-ch-th-gen-activator.php';
	Ch_Th_Gen_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-ch-th-gen-deactivator.php
 */
function deactivate_ch_th_gen() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-ch-th-gen-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-ch-th-gen.php';
